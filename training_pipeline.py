...
import src.svm.training as train
...
def training():
    ...
    if args.skip_fine_tune_encoder:
        ...
        data_set = train.vectorizer.tfidf_vectorizer(train_set, test_set, **param_dict)
    ...
    if args.skip_fine_tune_encoder:
        ...
        model = train.gridsearch_trainer.train_svm_model(data_set)
